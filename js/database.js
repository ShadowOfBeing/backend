...
answersAndQuestions = {
    ...
    'python': {
        ...
        18: {'question': 'Зачем нужна конструкция if __name__ == "__main__"?', 'answer': 'python answer 17'},
    ...
    'oop': {
        ...
        9: {'question': 'Какие магические методы есть у классов в Python?',
            'answer': `1) __new__<br>
                       ...
                       5) __str__ - служит для отображения информации об объекте класса (например для функций print, str)<br>
                       ...
                       17) __add__ - вызывается при применении к экземпляру класса оператора сложения<br>
                       18) __sub__ - вызывается при применении к экземпляру класса оператора вычитания<br>
                       19) __mul__ - вызывается при применении к экземпляру класса оператора умножения<br>
                       20) __truediv__ - вызывается при применении к экземпляру класса оператора деления<br>`},
