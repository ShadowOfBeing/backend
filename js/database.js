...
answersAndQuestions = {
    ...
    'python': {
        ...
        16: {'question': 'Что такое распаковка массива в Python?',
    ...
    'databases': {
        ...
        7: {'question': 'Что такое индексы в базе данных? Зачем они нужны? Назовите плюсы и минусы индексации.',
            'answer': `Плюсы:<br>
                       ...
                       <br>
                       Минусы:<br>
                       - замедляют процессы обновления, добавления, вставки данных в базу<br>
                       - увеличивают размер базы данных<br>
                       <br>
    ...
    'oop': {
        ...
        7: {'question': 'Как в Python указать модификатор private?',
            'answer': `В Python нет такого модификатора доступа, как private, как, например, в Java или C#. Вместо
                       ...
                       класса. В случае с одним подчёркиванием это лишь соглашение на словах, т.е. к фактически к таким
                       ...
                       нашим private методам, через эти имена к ним и можно обращаться. Т.е. по сути что одно, что два
                       подчёркивания являются лишь визуальным сигналом программисту, что эти методы и атрибуты предназначены
                       лишь для внутреннего использования внутри класса. Кстати, многие IDE подчёркивают как ошибку
                       обращение к таким атрибутам и методам, дополнительно сигнализируя программисту обратить внимание
                       что он нарушает правила. Однако всё же есть способы жёстко ограничить доступ к атрибутам и методам
                       в классе:<br>
                       Способ №1: использование библиотеки accessify. Она предоставляет декораторы @private и @protected,
                       которые можно прописать к нужному методу или атрибуту класса и тогда они получат реальный уровень
                       доступа private или protected и к ним нельзя будет обратиться извне.<br>
                       Способ №2: с помощью кастомных геттеров и сеттеров, которые можно прописать через декораторы @property
                       <br>
