...
answersAndQuestions = {
    ...
    22: {'question': 'Что такое хэш в Python?',
         'answer': `В Python хэш - это числовое значение, вычисляемое для любого объекта по определённому
                    алгоритму. В Python для вычисления хэша используется функция hash(). Важные замечания:<br>
