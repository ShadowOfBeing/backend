...
answersAndQuestions = {
    ...
    'python': {
        ...
        18: {'question': 'Что такое args и kwargs в Python?',
             'answer': `В Python это специальные параметры, которые позволяют передавать различное количество аргументов
                        ...
                        2<br>
                        3`},
        19: {'question': 'Какие типы параметров есть в Python?',
             'answer': `В функциях Python есть 4 типа параметров:<br>
                        ...
                        2) *args - параметр с переменным количеством позиционных аргументов. Параметр args представляется
                        ...
                        3) Именованные параметры - параметры, которые значения в которые передаются по имени параметра.<br>
